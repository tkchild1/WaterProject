...
const API_URL = "https://waterproject-backend-dscdcmagh6hhfrhk.francecentral-01.azurewebsites.net/api/Water";
...
export const fetchProjects = async (
    ...
    try {
        ...
        const response = await fetch(`${API_URL}/AllProjects?pageSize=${pageSize}&pageNum=${pageNum}${selectedCategories.length > 0 ? `&${categoryParams}` : ''}` );
